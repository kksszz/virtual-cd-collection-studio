...
public final class FavoriteButton {
    ...
    public static void bind(Button b,boolean favorite,String title){b.setText(favorite?"★":"☆");b.setTextColor(favorite?0xffffd166:0xff9cafbf);
        String description=title+"："+(favorite?jp.virtualcd.player.LanguageStrings.text("お気に入りを解除","Remove from favorites"):jp.virtualcd.player.LanguageStrings.text("お気に入りに登録","Add to favorites"));b.setContentDescription(description);b.setTooltipText(description);}
}
