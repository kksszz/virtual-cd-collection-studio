...
internal static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> JapaneseToEnglish =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["ライナーノーツ"] = "Liner Notes", ["Spine Card（帯）"] = "Spine Card (Obi)", ["Spine Card（帯・裏面）"] = "Spine Card (Obi reverse)",
            ...
            ["ブックレット閲覧"] = "Booklet viewer",
            ["切り抜き"] = "Crop",
            ["最近追加した順"] = "Recently added",
            ["YouTubeで動画を検索"] = "Search videos on YouTube",
