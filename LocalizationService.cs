...
internal static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> JapaneseToEnglish =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["全曲の英数字・空白を半角に"] = "Half-width Letters/Digits/Spaces in All Tracks",
            ["このアルバム全曲の編集欄にある全角英数字・全角スペースを半角へ変換します。日本語・記号・スペースの数・ファイル名は変更しません。保存するまで元ファイルは変わりません。"] = "Convert full-width Latin letters, digits and spaces in all editable fields of this album. Japanese text, symbols, the number of spaces and file names are unchanged. Files change only when saved.",
